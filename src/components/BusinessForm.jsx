...
import FormRatingField from '../components/FormRatingField.jsx'
...
class BusinessForm extends React.Component {
  ...
  handleFormSubmit = (values) => {
    this.props.addBusinessFirebase(values, this.props.userId, this.props.rating)
  };
          ...
          <div>
            <div>
              <Rating
                ...
                onChange={(value) => this.props.addBusinessRating(value)}
